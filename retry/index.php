    ...
    <div>
      ...
      >
       ...
       <div class="flex flex-col">
        <img src="./../assets/images/retry.svg" alt="" class="h-76 mt-6">
        <div>
            <h1 class="text-center text-3xl text-white font-bold" id="checkmarkalert">Verification Failure</h1>
            <h4 class="px-8 max-w-96 text-center text-white opacity-70 ">One or more than one feild provided is invalid or incorrect , Please retry with correct information .</h4>
        </div>
       </div>
      </div>
    </div>
