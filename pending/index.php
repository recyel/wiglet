    ...
    <div>
      ...
      >
       ...
       <div class="flex flex-col">
        <img src="./../assets/images/check.svg" alt="" class="h-64 mt-12">
        <div>
            <h1 class="text-center text-3xl text-white font-bold" id="checkmarkalert">Your Verification Is Pending.</h1>
            <h4 class="px-8 max-w-96 text-center text-white opacity-70 ">Your response have been recorded and will be reviewed manually under 48 hours . Please check your wallet for more further informations .</h4>
        </div>
       </div>
      </div>
    </div>
