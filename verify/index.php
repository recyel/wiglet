    ...
    <div>
      ...
      >
       ...
       <div class="mt-14 text-center  border m-12 px-8 py-4 rounded-lg border-[#575757] max-w-lg">
        <h2 class="text-2xl font-semibold text-white">Verify backup secret phrase </h2>
        <h5 class="leading-7 [&:not(:first-child)]:mt-6 text-[#8C8C8C]">When you initialised the wallet, you will have received a backup phrase. This phrase helps keep your wallet safe in event of destruction of your device or corruption of data. You will be required to enter the phrase in order to verify it in the next step.</h5>
        <div class="flex items-center mt-6 border rounded-xl p-2 border-[#48FF91] "> 
            <img src="../assets/images/trust.svg" alt="" class="h-8">
            <h4 class="text-[#48FF91] text-sm">If you have not received it, please open your wallet, and there should be a large backup banner on top.</h4>
        </div>
